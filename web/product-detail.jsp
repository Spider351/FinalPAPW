            ...
            <div class="flex-w flex-sb">
                ...
                <div class="w-size14 p-t-30 respon5">
                    ...
                    <div class="p-b-45">
                        ...
                        <span class="s-text8">Categorías: Vinos y Licores, Ron</span>
                    </div>
                    ...
                    <div class="wrap-dropdown-content bo6 p-t-15 p-b-14 active-dropdown-content">
                        ...
                        <div class="dropdown-content dis-none p-t-15 p-b-23">
                            <p class="s-text8">
                                Importado desde el Caribe y envejecido en barricas de roble entre doce y veinticuatro meses Kraken Rum tiene una inconfundible personalidad gracias a sus trece 
                                especias exóticas entre las que encontramos la canela, el jengibre y el clavo El diseño de la botella que contiene este ron es una réplica de las botellas de ron 
                                victorianas, con dos asas laterales El color negro oscuro está inspirado en el negro de la tinta misteriosa con la que, según la leyenda, el Kraken cubría a su presa.
                            </p>
                        </div>
                    </div>
